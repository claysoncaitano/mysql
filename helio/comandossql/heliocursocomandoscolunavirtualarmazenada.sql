...
SELECT concat(nome,' - ',descricao),preco_compra FROM produto;
...
,nome VARCHAR(100) NOT NULL 
,descricao VARCHAR(1000) NOT NULL 
,nome_completo VARCHAR(100) AS (concat(nome,' - ',descricao)) -- coluna gerada virtual
,preco_compra DECIMAL(10,2) NOT NULL
,CONSTRAINT pk_produto PRIMARY KEY (id)
);
...
-- criando tabela com coluna gerada armazenada para preco_venda_minima
CREATE TABLE produto(
id INT NOT NULL auto_increment
,nome VARCHAR(100) NOT NULL 
,descricao VARCHAR(1000) NOT NULL 
